...
public interface IJWTService {
     ...
     * */
    LoginOrRegisterResponse generateToken(String username, String password) throws Exception;

    /**
     * <h2>生成指定超时时间的 Token, 单位是天</h2>
     * */
    LoginOrRegisterResponse generateToken(String username, String password, int expire) throws Exception;
